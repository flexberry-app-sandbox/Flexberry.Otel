...
public class Komnaty {
    ...
    @Column(name = "КомнатаОт")
    private Integer комнатаот;
    ...
    public Integer getКомнатаОт() {
      return комнатаот;
    }

    public void setКомнатаОт(Integer комнатаот) {
      this.комнатаот = комнатаот;
    }
