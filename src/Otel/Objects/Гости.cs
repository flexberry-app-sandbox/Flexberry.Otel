...
namespace IIS.Otel
{
    ...
    public class Гости : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Otel.Авторизация fАвторизация;
        ...
        [PropertyStorage(new string[] {
                "Авторизация"})]
        [NotNull()]
        public virtual IIS.Otel.Авторизация Авторизация
        {
            get
            {
                ...
                IIS.Otel.Авторизация result = this.fАвторизация;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГостиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГостиE", typeof(IIS.Otel.Гости));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГостиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГостиL", typeof(IIS.Otel.Гости));
                }
            }
        }
    }
